...
public class Lesson8 {
	...
	public static void main(String[] args) {
		...
		students.add(new StudentLesson8("Giang1",5f));
		students.add(new StudentLesson8("Giang2",7f));
		students.add(new StudentLesson8("Giang3",4f));
		students.add(new StudentLesson8("Giang3",8f));
		System.out.println("Danh sách chưa sắp xêp");
		for (StudentLesson8 student : students){
			System.out.println(student);
		}
		Collections.sort(students);
		System.out.println("Danh sách đã sắp xêp");
		for (StudentLesson8 student : students){
			System.out.println(student);
		}
